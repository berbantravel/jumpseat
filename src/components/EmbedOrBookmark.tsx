...
const EmbedOrBookmark: React.FC<EmbedOrBookmarkProps> = ({ embedLink, embedImageUrl, embedAuthor, platform }) => {
      ...
      <>
        {!embedFailed && embedLink ? (
          <div className="flex justify-center mt-4">
            <ReactPlayer url={embedLink} width="100%" onError={handleEmbedError} />
          </div>
        ) : (
  ...
  export default EmbedOrBookmark