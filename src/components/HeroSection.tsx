            ...
            <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
              <div className="lg:pr-8 lg:pt-28">
                <div className="lg:max-w-lg">
                  ...
                  <p className="mt-6 text-justify text-lg leading-8 text-white">
                    Embark on a journey with us and meet Asia in its most
                    authentic. awe-inspiring form. Let us show you the finest
                    treasures of this diverse and stunning region-where every
