  ...
  return (
    <>
      ...
      <div className="flex min-h-screen items-center justify-center bg-gray-100">
        <div className="mx-auto flex h-screen w-full max-w-xl items-center justify-center rounded-lg bg-white shadow-sm sm:max-h-[500px]">
          <div className="zlg:max-w-7xl mx-auto grid max-w-3xl grid-cols-1 rounded-lg lg:grid-flow-col-dense lg:grid-cols-1">
            <div className="space-y-6 lg:col-span-2 lg:col-start-1">
              <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
                <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                  ...
                  alt="Your Company"
                /> */}
                  <h2 className="heading2SemiBold text-center text-gray-900">
                    Set your password
                  </h2>

                  <div className="mb-10 mt-1 flex items-center justify-center self-center">
                    <h2 className="body2Light mr-2 text-center text-gray-900">
                      johndoe24@gmail.com
                    </h2>
                  </div>
                </div>
                ...
                <div className="mt-1 sm:mx-auto sm:w-full sm:max-w-sm">
                  <form className="space-y-2" action="#" method="POST">
                    ...
                    {/* <div className="mt-6 grid grid-cols-1 gap-2 sm:mx-auto sm:w-full sm:max-w-sm">
