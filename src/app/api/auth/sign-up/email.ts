      ...
      html: `
        <div style="font-family: Arial, sans-serif; text-align: center; max-width: 600px; margin: 0 auto;">
          ...
          <div style="margin-bottom: 20px;">
            ...
            <a href="berbantravel.com/who-we-are" style="text-decoration: none; background-color: #d32f2f; color: white; padding: 12px 20px; border-radius: 6px; margin: 5px; display: inline-block;">ABOUT US</a>

            <a href="berbantravel.com/boracay-activities/" style="text-decoration: none; background-color: #d32f2f; color: white; padding: 12px 20px; border-radius: 6px; margin: 5px; display: inline-block;">Our Activities</a>
          </div>
